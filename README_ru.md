# chan_dongle - Драйвер каналов Asterisk для Huawei UMTS модемов

[🇬🇧 English](README.md) | [🇷🇺 Русский](README_ru.md)

## Обзор

**chan_dongle** — драйвер каналов для Asterisk PBX, который позволяет использовать Huawei UMTS 3G модемы как телефонные каналы с поддержкой голосовых вызовов, SMS и USSD.
